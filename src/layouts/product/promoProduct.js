        ...
        <div className={styles.leftContent}>
            ...
            <div className={styles.cardPromo}>
                <div className={styles.mothersDay}>
                    ...
                    <p>Get one of our favorite<br/> menu for free!</p>
                </div>
                <div className={styles.morningPromo}>
                    <h4>Get a cup of coffee for free<br/> on sunday morning</h4>
                    <p>Only at 7 to 9 AM</p>
                </div>
                <div className={styles.halloweenPromo}>
                    <h4>HAPPY HALLOWEEN</h4>
                    <p>Do you like chicken wings? Get 1<br/> free only if you buy pinky promise</p>
                </div>
